...
#define channelID "<ThingSpeak Channel ID>"
const char mqttUserName[] = "<Thingspeak_MQTT_Username>"; // Use any name
const char mqttPass[] = "<ThingSpeak_MQTT_Password>"; // Change to MQTT API Key from Account > MyProfile
const char clientID[] = "<ThingSpeak_MQTT_ClientID>";
...
void setup() {
  ...
  // Set ThingSpeak Fingerprint
  client.setFingerprint(thingspeak_cert_thumbprint);

   // Servo Motor Setup For Locked Position
